...
Thanks for your interest in contributing to the **pwshBedrock Project**.
...
When filing an issue, please check [existing open](https://github.com/techthoughts2/pwshBedrock/issues), or [recently closed](https://github.com/techthoughts2/pwshBedrock/issues?q=is%3Aissue+is%3Aclosed), issues to make sure somebody else hasn't already
...
Looking at the existing issues is a great way to find something to contribute on. As our projects, by default, use the default GitHub issue labels (enhancement/bug/duplicate/help wanted/invalid/question/wontfix), looking at any ['help wanted'](https://github.com/techthoughts2/pwshBedrock/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) issues is a great place to start.
...
See the [LICENSE](https://github.com/techthoughts2/pwshBedrock/blob/main/LICENSE) file for our project's licensing.
