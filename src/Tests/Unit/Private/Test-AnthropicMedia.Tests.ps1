...
InModuleScope 'pwshBedrock' {
    Describe 'Test-AnthropicMedia Private Function Tests' -Tag Unit {
        BeforeAll {
        ...
        Context 'Error' {
            ...
            It 'Should return false if an error is encountered running Test-Path' {
                ...
                $result = Test-AnthropicMedia -MediaPath $mediaPath
        ...
        Context 'Success' {
            ...
            It 'Should warn the user if the resolution is too large' {
                ...
                Mock Write-Warning {}
                $mediaPath = 'C:\path\to\image.jpg'
                Test-AnthropicMedia -MediaPath $mediaPath
                Should -Invoke Write-Warning -Exactly 3
            } #it

        } #context_Success

    } #describe_Test-AnthropicMedia
} #inModule
