...
InModuleScope 'pwshBedrock' {
    Describe 'Test-StabilityAIDiffusionMedia Private Function Tests' -Tag Unit {
        BeforeAll {
        ...
        Context 'Error' {
            ...
            It 'Should return false if an error is encountered running Test-Path' {
                ...
                $result = Test-StabilityAIDiffusionMedia -MediaPath $mediaPath
    ...
    } #describe_Test-StabilityAIDiffusionMedia
} #inModule
